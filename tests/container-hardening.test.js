...
test('CI verifica conteúdo, escaneia a imagem e exige healthcheck da release', () => {
  ...
  assert.match(workflow, /EASYPANEL_WORKER_SERVICE: worker-managed/)
  assert.match(workflow, /process\.env\.EASYPANEL_SERVICE \|\| 'api'/)
  assert.match(workflow, /process\.env\.EASYPANEL_WORKER_SERVICE \|\| 'worker-managed'/)
